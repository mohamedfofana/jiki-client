...
export class CoreStatics {
  static components = [TopMenuComponent,
    ...
    static modules = [RouterModule,
      ...
      ModalModule,
      ConfirmDialogModule];
    static services = [BacklogService, StoryService,StorageService, UserService,
            SorterService, FilterService, DataService,
            TrackByService, DialogService, AuthService,
            EventBusService, SprintService,LoggerService,ProjectService,AppConfigService, TeamService];
